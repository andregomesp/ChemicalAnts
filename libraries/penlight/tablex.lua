...
-- @module pl.tablex
local utils = require ('libraries.penlight.utils')
local types = require ('libraries.penlight.types')
...
local function setmeta (res,tbl,pl_class)
    local mt = getmetatable(tbl) or pl_class and require('libraries.penlight.' .. pl_class)
    return mt and setmetatable(res, mt) or res
end

local function makelist(l)
    return setmetatable(l, require('libraries.penlight.List'))
end

local function makemap(m)
    return setmetatable(m, require('libraries.penlight.Map'))
end
...
function tablex.makeset (t)
    assert_arg_indexable(1,t)
    return setmetatable(tablex.pairmap(set_op,t),require('libraries.penlight.Set'))
end
