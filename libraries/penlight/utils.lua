...
local compat = require 'libraries.penlight.compat'
...
function utils.function_arg (idx,f,msg)
    ...
    if tp == 'string' then
        if not operators then operators = require 'libraries.penlight.operator'.optable end
...
--     "-lluacov",
--     "-e",
--     "utils = print(require('libraries.penlight.utils')._VERSION",
-- }
-- -- returns: -lluacov -e 'utils = print(require('\''libraries.penlight.utils'\'')._VERSION'
