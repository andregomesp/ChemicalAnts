...
local callable = require 'libraries.penlight.types'.is_callable
...
function seq.copy(iter)
    ...
    setmetatable(res, require('libraries.penlight.List'))
    return res
end
...
function seq.count_map(iter)
    ...
    return setmetatable(t, require('libraries.penlight.Map'))
end
